    ...
    Selectpicker.prototype = {
        ...
        createDropdown: function() {
            ...
            var drop =
                "<div class='btn-group bootstrap-select" + multiple + "'>" +
                    ...
                    "</div>" +
                "</div>";
                $('select.select[data-style="btn-info"]').next().find('.dropdown-menu').addClass('select-blue');
                $('select.select[data-style="btn-success"]').next().find('.dropdown-menu').addClass('select-green');
                $('select.select[data-style="btn-warning"]').next().find('.dropdown-menu').addClass('select-orange');
                $('select.select[data-style="btn-danger"]').next().find('.dropdown-menu').addClass('select-red');
                $('select.select[data-style="btn-gr-gray"]').next().find('.dropdown-menu').addClass('btn-gr-gray');
                $('select.select:not([data-style])').next().find('button.dropdown-toggle').addClass('btn-gr-gray');
            return $(drop);
        ...
        createA: function(text, classes, inline) {
            return '<a tabindex="0" class="'+classes+'" style="'+inline+'">' +
                 text +
                 '<i class="icon-checkmark check-mark"></i>' +
                 '</a>';
        },
